...
@Composable
fun PlantWateringHeader(wateringInterval: Int) {
    Column(
        Modifier
            .fillMaxWidth()
    ) {
        ...
        Text(
            ...
            modifier = centerWidthPaddingModifier.padding(normalPadding)
        )
...
fun PlantDescription() {
    MaterialTheme {
        PlantDescription(description = "HTML<br><br><b>description</b/>")
    }
}
